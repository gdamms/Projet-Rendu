            ...
            switch (light.type) {
                ...
                case POINT:
                    try {
                        ...
                        double cos_nl = normal.dot(l) / normal.norm() / l.norm();
                        double Id = light.params[3] * kd * cos_nl;

                        /* specular contribution */
                        double cos_hn = h.dot(normal) / h.norm() / normal.norm();
                        double Is = light.params[3] * ks * Math.pow(cos_hn, s);
